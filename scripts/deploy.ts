...
//require("../artifacts/contracts/oracleprice/chainlink/ChainlinkTwoFeedPriceOracle.sol:ChainlinkTwoFeedPriceOracle")
import type { ChainlinkTwoFeedPriceOracleFactory } from "../typechain-types/contracts/oracleprice/chainlink/ChainlinkTwoFeedPriceOracleFactory";
import type { ChainlinkTwoFeedPriceOracle } from "../typechain-types/contracts/oracleprice/chainlink/ChainlinkTwoFeedPriceOracle";
import type { ChainlinkFeedPriceOracleFactory } from "../typechain-types/contracts/oracleprice/chainlink/ChainlinkFeedPriceOracleFactory";
import type { ChainlinkFeedPriceOracle } from "../typechain-types/contracts/oracleprice/chainlink/ChainlinkFeedPriceOracle";
import type { NativeGildFactory } from "../typechain-types/contracts/NativeGildFactory";
import type { NativeGild } from "../typechain-types/contracts/NativeGild";
