...
export interface ERC20GildFactoryInterface extends utils.Interface {
  functions: {
...
export interface ERC20GildFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC20GildFactoryInterface;
