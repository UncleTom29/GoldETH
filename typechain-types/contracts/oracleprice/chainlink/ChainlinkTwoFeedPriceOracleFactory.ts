...
export interface ChainlinkTwoFeedPriceOracleFactoryInterface
  extends utils.Interface {
  functions: {
    "createChild(bytes)": FunctionFragment;
    "createChildTyped((address,address))": FunctionFragment;
  ...
  encodeFunctionData(
    ...
    values: [ChainlinkTwoFeedPriceOracleConfigStruct]
  ): string;
...
export interface ChainlinkTwoFeedPriceOracleFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ChainlinkTwoFeedPriceOracleFactoryInterface;
