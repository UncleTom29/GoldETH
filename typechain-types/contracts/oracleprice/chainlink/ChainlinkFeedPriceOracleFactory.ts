...
export interface ChainlinkFeedPriceOracleFactoryInterface
...
export interface ChainlinkFeedPriceOracleFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ChainlinkFeedPriceOracleFactoryInterface;
